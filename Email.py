...
def send_email():
    ...
    receivers = {'stefan.kandler@emea-cosmetics.com': 'Stefan','christoph.razek@emea-cosmetics.com' : 'Chris', 'martin.bergler@emea-cosmetics.com' : 'Martin'}

    today =date.today()

    for r in receivers:
        text = f"""Hallo {receivers[r]},\n\nAnbei findest du die wöchentliche Bestandsauswertung.\nBei Fragen einfach melden\nMit freundlichen Grüßen\n\nChris"""
