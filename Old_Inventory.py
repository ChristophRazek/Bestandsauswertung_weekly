...
def old_invent():
    ...
    try:
        ...
        path = r"L:\Datenaustausch\Bestaende\Hist_Bestaende_wochenuebersicht"

        logging.info("Ziehe Historische Bestände.")
        ...
        #Replace Empty "Auslister" with "aktiv"
        dfs_concat['AUSLISTER'] = dfs_concat['AUSLISTER'].fillna('aktiv')
